    ...
    try {
        ...
        if (!content.trim()) {
            return await sock.sendMessage(
                remoteJid, 
                { text: `_⚠️ Usage Format | صيغة الاستخدام:_ \n\n_💬 Example | مثال:_ _*${prefix + command} melinda*_` }, 
                { quoted: message }
            );
        }
        ...
        // English: Call API to find name meaning with error handling
        // العربية: استدعاء API لمعرفة معنى الاسم مع معالجة الأخطاء
