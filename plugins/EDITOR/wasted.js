...
/**
 * Handle the Wasted poster command
 * معالجة أمر تحويل الصورة إلى ملصق Wasted
 */
async function handle(sock, messageInfo) {
    ...
    try {
        ...
        // Get the "wasted poster" image as Buffer
        ...
        console.error('Error processing Wasted command:', error);
        // حدث خطأ أثناء معالجة الأمر Wasted
...
module.exports = {
    handle,
    Commands    : ['wasted'], // Command handled by this module
