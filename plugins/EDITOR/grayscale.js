...
/**
 * Handle the grayscale command
 * معالجة أمر تحويل الصورة إلى تدرج رمادي (Grayscale)
 */
async function handle(sock, messageInfo) {
    ...
    try {
        ...
        const outputImagePath = `tmp/tmp_grayscale${Date.now()}.jpg`;
        ...
        if (fs.existsSync(outputImagePath)) {
            ...
            throw new Error("Grayscale file not found.");
        }
    } catch (error) {
