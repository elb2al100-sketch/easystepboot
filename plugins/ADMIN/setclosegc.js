// SET GROUP AUTO-CLOSE SCHEDULE: Set a daily time to automatically close the group
// تعيين جدول الإغلاق التلقائي للمجموعة: تحديد وقت يومي لإغلاق المجموعة تلقائياً
...
// Import moment-timezone to handle timezones
// استدعاء مكتبة moment-timezone لمعالجة المناطق الزمنية
...
async function handle(sock, messageInfo) {
    ...
    // الحصول على الوقت الحالي بتوقيت جاكرتا
...
_The bot will automatically close the group at this time every day / سيقوم البوت بإغلاق المجموعة تلقائياً في هذا الوقت كل يوم_ \n\n_To remove schedule type *.setclosegc off* / لإزالة الجدول اكتب *.setclosegc off*_`;
    ...
    if(content.trim() == 'off') {
        ...
        return await sock.sendMessage(
            remoteJid,
            { text: `_✅ Auto-close schedule successfully removed / تم حذف جدول الإغلاق التلقائي بنجاح_` },
            { quoted: message }
        );
    }
