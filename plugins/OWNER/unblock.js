...
async function handle(sock, messageInfo) {
    ...
    try {
        ...
        // Update user status to "active" and unblock on WhatsApp
        // تحديث حالة المستخدم إلى "نشط" وإلغاء الحظر على WhatsApp
        ...
        return await reply(
            m,
            `✅ _Number ${originalNumber} has been successfully unblocked!_\n✅ _Nomor ${originalNumber} berhasil dibuka dari pemblokiran!_`
        );
