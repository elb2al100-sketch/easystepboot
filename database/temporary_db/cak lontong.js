...
// ===============================================
module.exports = {
    DB_cak_lontong,  // Temporary in-memory database / قاعدة بيانات مؤقتة في الذاكرة
    addUser,         // Add user data / إضافة بيانات مستخدم
    removeUser,      // Remove user data / حذف بيانات مستخدم
    getUser,         // Retrieve user data / استرجاع بيانات المستخدم
    isUserPlaying,   // Check if user is playing / التحقق إذا كان المستخدم يلعب
};